...
First, set up the `config_list` in the `main.py` file (line 10). Read more about configurations [here](../../user-guide/advanced-concepts/llm-configuration-deep-dive.md).
