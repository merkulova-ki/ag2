...
Please modify the `config_list` in the `main.py` file (line 35). Read more about configurations [here](../../user-guide/advanced-concepts/llm-configuration-deep-dive.md). This configuration will be used to set up ag2 agents.
