...
A2UIAgent also supports the [AG-UI protocol](../../../user-guide/ag-ui/a2ui.md) for streaming A2UI over SSE to web frontends like CopilotKit.
...
- [A2UIAgent Reference](../../../user-guide/reference-agents/a2uiagent.md) — Full parameter reference, validation loop, actions, and integration guide
- [A2UI Protocol](https://a2ui.org/) — Official A2UI specification
- [AG-UI Integration](../../../user-guide/ag-ui/a2ui.md) — Streaming A2UI over AG-UI
- [A2A Server](../../../user-guide/a2a/server.md) — Serving agents via A2A
