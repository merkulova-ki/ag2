...
- Different [conversation patterns](../../../user-guide/advanced-concepts/pattern-cookbook/overview.md) like [sequential chats](../../../user-guide/advanced-concepts/orchestration/sequential-chat.md), [group chat](../../../user-guide/advanced-concepts/orchestration/group-chat.md), [constrained group chat](../../../user-guide/advanced-concepts/orchestration/group-chat.md), [customized group chat](../../../user-guide/advanced-concepts/groupchat/custom-group-chat.md), [nested chat](../../../user-guide/advanced-concepts/orchestration/nested-chat.md) and recursive composition of them.
- Different prompting and reasoning techniques such as [reflection](../../../use-cases/notebooks/notebooks/agentchat_lats_search.md#reflection).
- [Tool use](../../../user-guide/advanced-concepts/tools/ag2-built-in-tools-support.md) and [code execution](../../../user-guide/advanced-concepts/code-execution.md), as well as their [combination](../../../user-guide/advanced-concepts/code-execution.md).
- [Planning and task decomposition](../../../user-guide/advanced-concepts/pattern-cookbook/star.md#key-characteristics).
- [Retrieve augmentation](../../../user-guide/advanced-concepts/rag.md).
