...
categories:
    ...
    - Debugging
date: 2026-02-08
slug: AG2-OpenTelemetry-Tracing
---
...
For local development and testing, the documentation includes a ready-to-use Docker Compose configuration that runs an OpenTelemetry Collector, Grafana Tempo (trace storage), and Grafana (visualization). See the [Local OpenTelemetry Setup](../../../user-guide/tracing/local-setup.md) page for the full configuration files and step-by-step instructions.
...
- [OpenTelemetry Tracing documentation](../../../user-guide/tracing/opentelemetry.md) -- Full API reference, semantic attributes, and more examples
- [Tracing Remote Agents](../../../user-guide/tracing/remote-agents.md) -- Distributed tracing with A2A in detail
- [Local OpenTelemetry Setup](../../../user-guide/tracing/local-setup.md) -- Docker Compose stack configuration
