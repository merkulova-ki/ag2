...
!!! warning
    ...
    Updating to the new group chat from your Swarm code is straightforward, see [this guide](../../../user-guide/advanced-concepts/orchestration/swarm/deprecation.md) on how to do it.

    The Swarm code has now been deprecated but will still function with some minor changes. See [this guide](../../../user-guide/advanced-concepts/orchestration/swarm/deprecation.md) to update your current Swarm code to work with v0.9 and up. We would advise updating your code to work with the new group chat with the Swarm code being deprecated.
...
* [Swarm Orchestration Documentation](../../../user-guide/advanced-concepts/orchestration/swarm/deprecation.md)
* [Swarm Orchestration Notebook](../../../use-cases/notebooks/notebooks/agentchat_swarm.md)
* [(Legacy) Implement Swarm-style Orchestration with GroupChat
](../../../use-cases/notebooks/notebooks/agentchat_swarm_w_groupchat_legacy.md)
