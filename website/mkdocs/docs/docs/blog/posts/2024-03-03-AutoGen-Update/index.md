...
!!! note "Deprecation Notice"
    Some features referenced in this blog post (`AgentOptimizer`, `GPTAssistantAgent`, multimodal agents) are deprecated as of v0.12 and will be removed in v0.14.
...
- [AgentEval](/docs/blog/2023/11/20/AgentEval/index). Our [research](https://arxiv.org/abs/2402.09015) finds that LLM agents built with AutoGen can be used to automatically identify evaluation criteria and assess the performance from task descriptions and execution logs. It is demonstrated as a [notebook example](https://github.com/ag2ai/ag2/blob/main/notebook/agenteval_cq_math.ipynb). Feedback and help are welcome for building it into the library.
- [AutoGenBench](/docs/blog/2024/01/25/AutoGenBench/index). AutoGenBench is a commandline tool for downloading, configuring, running an agentic benchmark, and reporting results. It is designed to allow repetition, isolation and instrumentation, leveraging the new [runtime logging](../../../use-cases/notebooks/notebooks/agentchat_logging.md) feature.
...
- [Custom models and clients](/docs/blog/2024/01/26/Custom-Models/) can be used as backends of an agent, such as Huggingface models and inference APIs.
- [OpenAI assistant](/docs/blog/2023/11/13/OAI-assistants/index) can be used as the backend of an agent (GPTAssistantAgent). It will be nice to reimplement it as a custom client to increase the compatibility with ConversableAgent.
- [Multimodality](/docs/blog/2023/11/06/LMM-Agent/index). LMM models like GPT-4V can be used to provide vision to an agent, and accomplish interesting multimodal tasks by conversing with other agents, including advanced image analysis, figure generation, and automatic iterative improvement in image generation.
...
- new features like [stateful code execution](../../../user-guide/advanced-concepts/code-execution.md), [tool decorators](../../../user-guide/advanced-concepts/tools/ag2-built-in-tools-support.md), [long context handling](../../../use-cases/notebooks/notebooks/agentchat_transform_messages.md), [web agents](../../../user-guide/reference-agents/websurferagent.md).
...
- sample apps like [AutoAnny](/docs/blog/2024/02/02/AutoAnny/index).
