...
This blog builds upon the concepts covered in the [Tool Integration notebook](../../../use-cases/notebooks/notebooks/tools_interoperability.md).
...
- `AssistantAgent` and `UserProxyAgent`: Core AG2 classes.
