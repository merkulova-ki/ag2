...
Here's a quick example of how to use the new agents and tools. If you're after more examples, see [this Notebook](../../../use-cases/notebooks/notebooks/agentchat_tools_commsplatforms.md).
