...
!!! example "Try it on the AG2 Playground"
    See group chat patterns running live at [playground.ag2.ai](https://playground.ag2.ai){:target="_blank"} — no setup required.
...
We kick off the conversation by calling `run_group_chat_iter()` method:
