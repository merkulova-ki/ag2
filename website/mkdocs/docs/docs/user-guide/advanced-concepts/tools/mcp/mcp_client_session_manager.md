...
For single-server, long-running workflows where you maintain one persistent connection, use the standard [MCP Clients](client.md) approach instead.
...
- [MCP Clients](client.md) — Standard MCP client setup and transport protocols
