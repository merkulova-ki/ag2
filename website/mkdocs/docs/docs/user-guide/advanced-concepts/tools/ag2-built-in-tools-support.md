...
!!! note
    Built-in tools are currently supported when using the OpenAI Responses API (`api_type: "responses"`). See [OpenAI Responses](../../models/openai_responses.md) for model requirements and setup.
...
!!! warning
    For production use, always configure `workspace_dir` and restrict `allowed_paths`. Use `allowed_commands` for strict control. See the [Shell Tool and Multi-tool Execution blog](/docs/blog/2025/12/24/AG2-Shell-Tool-and-multi-in-built-tool-execution/) for detailed security guidelines.
...
- [OpenAI Responses API](../../models/openai_responses.md) — Model provider setup and requirements
- [Tool Basics](basics.md) — General tool usage and registration in AG2
- [Blog: Shell Tool and Multi-tool Execution](/docs/blog/2025/12/24/AG2-Shell-Tool-and-multi-in-built-tool-execution/) — Shell tool configuration and security
- [Blog: GPT-5.1 Apply Patch Tool](/docs/blog/2025/12/22/GPT-5.1-Apply-Patch-Tool/) — File operations and diff format
