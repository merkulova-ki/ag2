...
The pattern implementations use AG2's  group chat orchestration, read more about it [here](../orchestration/group-chat/introduction.md).
...
### [Context-Aware Routing](context_aware_routing.md)
...
![Content Aware chat](./assets/context_aware_routing.png)
...
![Escalation chat](./assets/escalation_pattern.png)
...
![Feedback loop chat](./assets/feedback_loop_pattern.png)
...
### [Hierarchical / Tree](hierarchical.md)
...
![tree pattern chat](./assets/tree-hierarchical-pattern.png)
...
![Organic chat](./assets/organic_pattern.png)
...
### [Pipeline / Sequential Processing](pipeline.md)
...
![Sequential chat](./assets/sequential_pattern.png)
...
![redundant chat](./assets/redundant_pattern.png)
...
![Star and Hub chat](./assets/starpattern_example.png)
...
### [Triage with Tasks](triage_with_tasks.md)
...
![Triage with task chat](./assets/triage_tasks_pattern.png)
...
This pattern is used within our [`DocAgent`](../../reference-agents/docagent/docagent-performance.md) ([code](https://github.com/ag2ai/ag2/blob/main/autogen/agents/experimental/document_agent/document_agent.py)).
...
If you are able to catch those exceptions, you can transfer to an `error agent` in your group chat using either `ReplyResult` or setting a context variable (e.g. `my_agent.set_context("errored", True)`) and using an `OnContextCondition` to transfer to the error agent.
...
For more information on using the Group Chat framework itself, refer to the [Group Chat documentation](../orchestration/group-chat/introduction.md).
