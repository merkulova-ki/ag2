...
AG2 has a great feature - <a href="../advanced-concepts/tools/ag2-built-in-tools-support.md" className="internal-link">Tools</a>. Our A2A agent executor allows your remote agents to execute any tool by themselves. So, if your client calls an agent with a tool, their tools will be executed and the result processed by the remote agent, with a final result returned to the client.
...
- <a href="../advanced-concepts/orchestration/group-chat/context-variables.md" className="internal-link">Context Variables</a>
- <a href="../advanced-concepts/orchestration/group-chat/guardrails.md" className="internal-link">Guardrails</a>
...
A2UIAgent can serve rich, interactive UI components over A2A. See the dedicated [A2UI page](a2ui.md) for setup details, or the full [A2UIAgent reference](../reference-agents/a2uiagent.md) for configuration, validation, actions, and custom catalogs.
