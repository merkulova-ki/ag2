...
This is a lightweight alternative to [DeepResearchTool](deep-research.md) for quick fact-finding across multiple topics in parallel.
...
- [Tavily Search Tool](tavily-search.md) — standalone Tavily search without crawling or summarization
- [Deep Research](deep-research.md) — for complex, multi-step autonomous research tasks
- [Crawl4AI Tool](crawl4ai.md) — standalone web crawling without search or summarization
