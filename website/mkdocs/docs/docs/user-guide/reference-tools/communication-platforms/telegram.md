...
!!! tip
    Consider [`TelegramAgent`](../../reference-agents/communication-platforms/telegramagent.md) if you don't want to build your agent with these tools, it is a ready-to-go AG2 agent that already incorporates the tools and messaging instructions.
...
![Discord output](../../reference-agents/assets/commsplatforms_telegram_sentmsg.png)
