...
!!! tip
    Consider [`SlackAgent`](../../reference-agents/communication-platforms/slackagent.md) if you don't want to build your agent with these tools, it is a ready-to-go AG2 agent that already incorporates the tools and messaging instructions.
...
![Slack output](../../reference-agents/assets/commsplatforms_slack_sentmsg.png)
