...
A2UIAgent extends AG-UI with support for the A2UI protocol, enabling agents to generate structured UI components (cards, forms, buttons, images) instead of plain text. See the dedicated [A2UI page](./a2ui.md) for setup details, or the full [A2UIAgent reference](../reference-agents/a2uiagent.md) for configuration, validation, actions, and A2A integration.
