...
For local development and testing, you can run an OpenTelemetry Collector, Grafana Tempo, and Grafana using Docker Compose. See the [Local OpenTelemetry Setup](local-setup.md) page for the full configuration files and instructions.
