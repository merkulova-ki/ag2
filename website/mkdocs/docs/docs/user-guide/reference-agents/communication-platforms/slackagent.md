...
Find out more about these tools and how you can add them to your own AG2 agents in the [Slack Tools](../../reference-tools/communication-platforms/slack.md) documentation.
