...
!!! tip
    If you're looking to add communication abilities to your existing AG2 agents, you can use the tools that underpin these agents, see [Discord Tools](../../reference-tools/communication-platforms/discord.md), [Slack Tools](../../reference-tools/communication-platforms/slack.md), and [Telegram Tools](../../reference-tools/communication-platforms/telegram.md).
...
Discord, Slack, and Telegram all have their own authentication and channel/group/bot identifiers. See this [notebook](../../../use-cases/notebooks/notebooks/agentchat_tools_commsplatforms.md) for more guidance on establishing those authentication details and identifiers.
...
- [DiscordAgent](discordagent.md)
- [SlackAgent](slackagent.md)
- [TelegramAgent](telegramagent.md)

### More Code examples

See our [blog post](/docs/blog/2025/02/05/Communication-Agents/) for a demonstration of using the communication agents and this [notebook](../../../use-cases/notebooks/notebooks/agentchat_tools_commsplatforms.md) for examples of using all the communication tools, and guidance on establishing the relevant authentication tokens and IDs.
