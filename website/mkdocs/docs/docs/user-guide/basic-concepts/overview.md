...
[Learn more about LLM Configuration →](llm-configuration.md)
...
[Learn more about ConversableAgent →](conversable-agent.md)
...
[Learn more about Human in the Loop →](human-in-the-loop.md)
...
This orchestration enables you to build rich, collaborative, multi-agent applications. [Learn more about Agent Orchestration →](introducing-group-chat.md)
...
[Learn more about Tools →](introducing-tools.md)
...
[Learn more about Structured Outputs →](structured-outputs.md)
...
**Next up**: Dive deeper into each of these components, starting with [LLM Configuration](llm-configuration.md) — the foundation for all AG2 agents.
