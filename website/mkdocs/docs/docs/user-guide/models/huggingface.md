...
For more information, please refer to the [installation guide](../basic-concepts/installing-ag2.md).
...
- [Interactive Notebook Example](../../use-cases/notebooks/notebooks/agentchat_custom_model.md) - Full working example with code
- [LLM Configuration Guide](../basic-concepts/llm-configuration.md) - Learn more about configuring LLMs
