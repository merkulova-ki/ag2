...
Before starting this guide, ensure you have completed the [Installation Guide](installation.md) and installed all required dependencies.
...
llm_config = LLMConfig({"model": "openai-gpt-5-nano", "base_url": "http://0.0.0.0:4000"})
