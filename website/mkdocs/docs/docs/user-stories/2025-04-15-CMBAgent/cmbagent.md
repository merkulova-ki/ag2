...
<div class="card">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="../img/boris_profile.png" />
      </div>
      <div>
        <p class="name">Boris Bolliet</p>
        <p>Researcher, Cambridge University</p>
      </div>
    </div>
</div>
...
<div class="card">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="../img/inigo_profile.png" />
      </div>
      <div>
        <p class="name">Inigo Zubeldia</p>
        <p>Researcher, Cambridge University</p>
      </div>
    </div>
</div>
...
<div class="card">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="../img/james_profile.png" />
      </div>
      <div>
        <p class="name">James Fergusson</p>
        <p>Professor, Cambridge University</p>
      </div>
    </div>
</div>
...
<div class="card">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="../img/francisco_profile.png" />
      </div>
      <div>
        <p class="name">Francisco Villaescusa-Navarro</p>
        <p>Research Scientist, Simons Foundation</p>
      </div>
    </div>
</div>
