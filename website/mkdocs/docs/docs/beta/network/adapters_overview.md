...
|---|---|---|
| 1Q1R — strict question-and-answer, auto-closes after the reply | `#!python consulting` | [Consulting](consulting.md) |
| 2-party free-form chat with no turn ordering | `#!python conversation` | [Conversation](conversation.md) |
| N-party round-robin discussion | `#!python discussion` | [Discussion](discussion.md) |
| Declarative orchestration (group-chat-with-handoff style) | `#!python workflow` | [Workflow](workflow.md) |
