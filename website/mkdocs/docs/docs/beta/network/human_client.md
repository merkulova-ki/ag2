...
- [Hub & Identity](hub_and_identity.md) — `#!python Passport.kind`, `#!python Rule`, registration.
- [Human in the Loop](../context/human_in_the_loop.md) — pausing a *single* `#!python Agent` mid-run for input (a different, in-process mechanism).
