...
For lightweight LLM-driven sub-agent delegation see [Sub-task Delegation](task_delegation.md) — that's a different feature that wraps an Agent in a `#!python run_subtask` tool.
